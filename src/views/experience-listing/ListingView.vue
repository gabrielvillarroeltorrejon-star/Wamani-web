      ...
      <div class="catalog-header-container text-center mb-5">
        ...
        <div class="search-filter-box mx-auto p-3 p-md-4 rounded-4 shadow-lg">
          <div class="row g-3 align-items-center">
            ...
            <div class="col-12 col-sm-6" :class="searchQuery || selectedCity || selectedDifficulty || searchDate ? 'col-md-2' : 'col-md-3'">
              <div class="input-icon-wrapper position-relative">
                <i class="bi bi-geo-alt-fill select-icon"></i>
                <select v-model="selectedCity" class="form-select custom-select-input text-white fw-medium">
            ...
            <div class="col-12 col-md-1 d-flex align-items-center justify-content-center" v-if="searchQuery || selectedCity || selectedDifficulty || searchDate">
              <button 
        ...
        <div class="row g-4">
          <div v-for="exp in filteredExperiences" :key="exp.id" class="col-md-6 col-lg-4">
          ...
          <div v-if="filteredExperiences.length === 0" class="col-12 text-center py-5 text-white fw-bold">
...
.portfolio-hero {
  ...
  min-height: 400px;
  overflow: hidden;
  background: url('https://images.unsplash.com/photo-1454496522488-7a8e488e8606?auto=format&fit=crop&w=1920&q=80') center/cover no-repeat;
